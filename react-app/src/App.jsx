  ...
  return (
    ...
    <form className={`container border border-${variant} rounded shadow-sm mt-4 d-flex flex-column gap-4 p-4`} onSubmit={handleSubmit}>
      ...
      <div className="form-group w-25 mx-auto">
        <label className={`text-${variant}`}>Selecionar a cor</label>
      ...
      <Campo variant={variant} id="nome" value={nome}  label="Nome" onChange={e => setNome(e.target.value)} />
      <Campo variant={variant} id="email" value={email}  label="email" type='email' onChange={e => setEmail(e.target.value)} />
      <Campo variant={variant} id="senha" value={senha} label="senha" type='passaword' onChange={e => setSenha(e.target.value)} />
      <Campo id="cep" label="CEP" variant={variant} type="number" value={cep} onChange={handleCep} />
      <Campo id="logradouro" label="Logradouro" variant={variant} type="text" value={logradouro} onChange={e => setLogradouro(e.target.value)}/>
